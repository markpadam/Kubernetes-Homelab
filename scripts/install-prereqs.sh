...
echo -e "    ${CYAN}./aks-lab doctor${RESET}                                 # verify prerequisites before setup"
echo -e "    ${CYAN}./aks-lab setup${RESET}                                  # provision the cluster (auto-starts + sizes Colima for the chosen tier)"
