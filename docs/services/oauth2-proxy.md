...
The `oauth2-proxy-secret` Kubernetes secret is rendered from the template at `gitops/infrastructure/base/identity/oauth2-proxy/secret.yaml` at setup time. It contains:
