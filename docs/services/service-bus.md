...
**Managed by:** Flux (`flux/apps/base/service-bus/`)
...
To add queues or topics, edit `flux/apps/base/service-bus/config.yaml` and commit — Flux will apply the change and the emulator will reload on pod restart.
